                            ...
                            <div class="product-single-content">
                                ...
                                <div class="price">
                                    <span class="present-price">&#2547;
                                        {{ number_format($product_details->after_discounter) }}</span>
                                ...
                                <div class="product-filter-item color">
                                    <div class="color-name">
                                        <span>Color :</span>
                                        <ul>
                                            @foreach ($ava_colors as $color)
                                                <li class="">
                                                    <input id="color{{ $color->color_id }}" type="radio"
                                        ...
                                        @error('color_id')
                                            <strong class="text-info">Please select your color</strong>
                                        @enderror
                                    </div>
                                </div>
                                {{-- <div class="product-filter-item color">
                                ...
                                <div class="product-filter-item color filter-size">
                                    <div class="color-name">
                                        <span>Sizes:</span>
                                        <ul class="ava_size">
                                            @foreach ($ava_sizes as $size)
                                                <li class="">
                                                    <input id="size{{ $size->size_id }}" type="radio"
                                                        name="size_id" class="size_id" value="{{ $size->size_id }}" >
                                                    <label for="size{{ $size->size_id }}"
                                                        style="background-color:"{{ $size->rel_to_size->size_name }}></label>
                                                </li>
                                            @endforeach
                                        </ul>
                                        @error('size_id')
                                            <strong class="text-info">Please select your size</strong>
                                        @enderror
                                    </div>
                                </div>
                                <div class="pro-single-btn">
                                    ...
                                    @auth('customer')
                                        <button class="theme-btn-s2">Add to cart</button>
                                    @else
