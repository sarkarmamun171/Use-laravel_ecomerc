             ...
             <div class="featured-categorie-slider owl-carousel">
                 @foreach ($categories as $category)
                     <div class="featured-item">
                         <div class="images">
                             <img style="width:70px!important; margin:auto"
                                 src="{{ asset('uploads/category') }}/{{ $category->category_image }}" alt="">
                         </div>
                         <div class="text">
                             <h2>
                                 @if (Str::length($category->category_name) > 12)
                                     <a href="{{ route('category.product',$category->id) }}" title="{{ $category->category_name }}">
                 ...
                 <div class="row">
                     ...
                     <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img src="{{ asset('uploads/product/preview') }}/{{ $product-> pre_image}}" alt="">
                                @if ($product->discount)
                            ...
                            <div class="text">
                                ...
                                <div class="price">
                                    <span class="present-price">&#2547; {{ number_format($product->after_discounter) }}</span>
                                    @if ($product->discount)
                 ...
                 <div class="col-lg-4 col-md-6 col-12">
                     <div class="highlight-wrap">
                         ...
                         <div class="product-card">
                            ...
                            <div class="content">
                                <h3><a href="product-single.html" title="{{ $product->product_name }}">
                                    @if (strlen($product->product_name)>20)
