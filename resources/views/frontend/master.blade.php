                        ...
                        <div class="col-lg-4 col-12">
                            <div class="middle-right">
                                <ul>
                                    ...
                                    @auth('customer')
                                    <li><a href="{{ route('customer.profile') }}"><i class="fi flaticon-user-profile"></i><span>
                                        {{ Auth::guard('customer')->user()->fname }}</span></a></li>
                                    @else
                                    <li><a href="{{ route('customer.login') }}"><i class="fi flaticon-user-profile"></i><span>
                                        Login</span></a></li>
                                    @endauth
